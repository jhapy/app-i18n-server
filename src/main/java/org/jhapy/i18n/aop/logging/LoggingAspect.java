...
package org.jhapy.i18n.aop.logging;
...
public class LoggingAspect implements HasLogger {
   ...
   */
  @Pointcut("target(org.jhapy.i18n.service.CrudRelationalService)" +
      " || target(org.jhapy.i18n.service.CrudService)")
  public void serviceEndpoint() {
    // Method is empty as this is just a Pointcut, the implementations are in the advices.
  }

  @Pointcut("!execution(@org.jhapy.i18n.aop.logging.NoLog * *(..))")

...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter implements HasLogger {
  ...
  public void configure(HttpSecurity http) throws Exception {
    ...
    http.cors()
        ...
        .antMatchers("/api/elementTrlService/findByIso3").permitAll()
        .antMatchers("/api/actionTrlService/findByIso3").permitAll()
        .antMatchers("/api/messageTrlService/findByIso3").permitAll()
